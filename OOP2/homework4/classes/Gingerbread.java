...
public class Gingerbread implements Sweet {
    private final DoughType dough = DoughType.HONEY;
    private final FillingType filling = FillingType.NONE;
    private final GlazeType glaze = GlazeType.SUGAR_GLAZE;
    private final CreamType cream = CreamType.NO_CREAM;

    @Override
    public void prepare() {
        System.out.println("Preparing a donut: " + dough + ", " + filling + ", " + glaze + ", " + cream + ", 1 layers.");
    }
}
